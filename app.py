...
#EMOTE API
#Jaldi se subscribe kar do @aadixff
...
async def perform_emote(team_code: str, uids: list, emote_id: int):
    ...
    try:
        ...
        # MAGIC FIX: Bot ko group me properly load hone ke liye 1 second ka time dein
        ...
        # MAGIC FIX: Emote ka animation screen par aane ke liye 0.5 second ka time dein
        await asyncio.sleep(0.5)
        ...
        return {"status": "success", "message": "Emote done in one click"}
...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('16969642431')  # <-- FIXED BOT UID

    Uid, Pw = '6464373099', '6E9B49512B93F7571AE036D2AB021F93ACEBE40828D446D6EB4928F4EAAFFD53'
